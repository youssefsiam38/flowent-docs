...
description: 'Set up your local environment to develop with Flowent API Gateway'
---
...
See the [Code Examples](/api_gateway/examples/python/README) for complete implementations.
...
<AccordionGroup>
  ...
  <Accordion title="HMAC signature validation failing">
    ...
    5. See the [Signature Validation](/api_gateway/README#signature-validation) guide for detailed examples
  </Accordion>
...
- Review the [API Concepts](/api_gateway/README) for detailed technical information
- Check out [Code Examples](/api_gateway/examples/python/README) for complete implementations
